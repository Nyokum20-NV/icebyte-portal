...
export default function Hero() {
  return (
    <div className="relative min-h-[92vh] bg-[#030712] text-white flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div 
        className="absolute inset-0 bg-cover bg-center z-0 opacity-55 scale-100"
        style={{
          backgroundImage: `linear-gradient(to bottom, rgba(3, 7, 18, 0.45) 0%, rgba(3, 7, 18, 0.75) 50%, rgba(3, 7, 18, 0.98) 100%), url('https://images.unsplash.com/photo-1505881502353-a1986add3762?auto=format&fit=crop&w=2400&q=85')`
        }}
      />
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center pt-24 pb-12">
        {/* Live Status Badge */}
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-cyan-500/40 bg-slate-950/80 backdrop-blur-md text-cyan-300 text-xs font-semibold tracking-wider uppercase mb-6 shadow-lg shadow-cyan-950/50">
        ...
        <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight mb-6">
          ...
          <span className="bg-gradient-to-r from-white via-cyan-200 to-sky-400 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(6,182,212,0.4)]">
            Polar Archive
          </span>
        </h1>

        <p className="max-w-3xl mx-auto text-base sm:text-lg md:text-xl text-slate-200 leading-relaxed font-light mb-12 drop-shadow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-4xl mx-auto text-left">
          {/* Maitri Card */}
          <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-700/80 backdrop-blur-md hover:border-cyan-500/50 transition duration-300 shadow-xl">
